...
WData = pd.read_csv('Weiz_wLFC.csv')
...
dat_path = '/Users/zacharyazadian/RockLab Dropbox/Zachary Azadian/ChemGen/New_Data_Results/AAA_Final_Data/'
...
output_path = '/Users/zacharyazadian/RockLab Dropbox/Zachary Azadian/ChemGen/New_Data_Results/AAA_Final_Data/Weizhen_Comp/Supplement/'
...
def gen_Ci_table(gene_list, treatment_file, prefix):
    ...
    m_path = '/Users/zacharyazadian/RockLab Dropbox/Projects/chemical_genomics/data/MAGECK/'+treatment_file
...
writer = pd.ExcelWriter(output_path+'Final/Supplemental_Data_2_weizhen_automated.xlsx')
